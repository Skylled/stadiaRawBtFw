...
6. **Cheap win, untouched**: `bcm.c` (Broadcom BT chip HCI/patchram driver) — 52 attributed functions, 11,548 bytes, **zero decompiled** as of the last `bruce-decompile-status.md` regeneration. Already know the file and function boundaries; purely needs `Decompile.java` + reading.
