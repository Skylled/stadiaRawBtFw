// 600ea0e8  FUN_600ea0e8  size=184 bytes
// --- callers ---
...
void FUN_600ea0e8(uint *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  *param_1 = uVar3 ^ uVar5;
  ...
  uVar1 = FUN_6008893c(param_1,param_4,0,param_4,param_4);
  uVar1 = FUN_6008893c(uVar1,param_3,1);
  puVar2 = (uint *)FUN_6008893c(uVar1,param_2,0);
  uVar3 = (*puVar2 ^ puVar2[1] >> 1) & 0x55555555;
  uVar4 = *puVar2 ^ uVar3;
  uVar5 = puVar2[1] ^ uVar3 << 1;
  uVar3 = (uVar5 ^ uVar4 >> 8) & 0xff00ff;
  uVar5 = uVar5 ^ uVar3;
  uVar4 = uVar4 ^ uVar3 << 8;
  uVar3 = (uVar4 ^ uVar5 >> 2) & 0x33333333;
  uVar4 = uVar4 ^ uVar3;
  uVar5 = uVar5 ^ uVar3 << 2;
  uVar3 = uVar5 ^ uVar4 >> 0x10;
  uVar5 = uVar5 ^ uVar3 & 0xffff;
  uVar4 = uVar4 ^ uVar3 << 0x10;
  uVar3 = (uVar4 ^ uVar5 >> 4) & 0xf0f0f0f;
  *puVar2 = uVar4 ^ uVar3;
  puVar2[1] = uVar5 ^ uVar3 << 4;
  return;
}
