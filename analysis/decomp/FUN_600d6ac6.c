// 600d6ac6  FUN_600d6ac6  size=226 bytes
// --- callers ---
//   600d6ba8 FUN_600d6ba8
// --- callees ---
//   600d6a54 FUN_600d6a54


undefined4 * FUN_600d6ac6(undefined4 *param_1,int param_2,int param_3,uint param_4)

{
  ...
  do {
    ...
    if (param_3 == iVar7) goto LAB_600d6b12;
    if (param_3 < iVar7) {
      iVar6 = iVar5 + -1;
    }
    else {
...
LAB_600d6b26:
  *(undefined1 *)((int)param_1 + 10) = local_26;
  return param_1;
LAB_600d6b66:
  FUN_600d6a54(&local_30,pbVar2 + 4);
  FUN_600d6a54(auStack_24,&local_30);
  if (local_2c != '\0') {
    *param_1 = local_30;
  }
