// 600da0f2  FUN_600da0f2  size=280 bytes
// --- callers ---
// --- callees ---
//   600da0d8 FUN_600da0d8


undefined4 *
FUN_600da0f2(undefined4 *param_1,int *param_2,int param_3,int param_4,undefined4 param_5)

{
  ...
  do {
    ...
    if (param_3 == iVar7) goto LAB_600da148;
    if (param_3 < iVar7) {
      iVar6 = iVar1 + -1;
    }
    else {
...
LAB_600da148:
  if ((param_3 == *piVar4) && (piVar4 != (int *)(iVar3 + 0x30))) {
    piVar8 = (int *)piVar4[1];
    for (iVar6 = 0; iVar6 != piVar4[2]; iVar6 = iVar6 + 1) {
      if (*piVar8 == param_4) goto LAB_600da182;
      piVar8 = piVar8 + 4;
    }
    ...
    if (local_28 == '\0') {
      for (iVar6 = 0; iVar6 != ((int *)param_2[0x1b])[1]; iVar6 = iVar6 + 1) {
        ...
        if (*(int *)(iVar2 + iVar6 * 0x10) == param_4) goto LAB_600da182;
      }
...
LAB_600da15c:
  *(undefined1 *)((int)param_1 + 10) = local_2e;
  return param_1;
LAB_600da182:
  FUN_600da0d8(&local_38,piVar8 + 1);
  pcVar5 = *(code **)(*param_2 + 0x28);
  FUN_600da0d8(auStack_2c,&local_38);
