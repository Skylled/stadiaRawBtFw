// 600d1c52  FUN_600d1c52  size=58 bytes
// --- callers ---
...
undefined4
FUN_600d1c52(int param_1,int param_2,undefined4 param_3,int param_4,int param_5,short param_6,
...

{
  ...
  if ((((param_5 == 0) || (param_6 == 0)) || (param_1 == 0)) || (*(int *)(param_1 + 0xc) == 0)) {
    ...
    uVar1 = FUN_600558b8(param_1,0xa1,param_3,param_4 << 8,
