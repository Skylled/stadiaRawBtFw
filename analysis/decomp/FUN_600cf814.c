// 600cf814  FUN_600cf814  size=98 bytes
// --- callers ---
// --- callees ---
//   600ced08 FUN_600ced08


void FUN_600cf814(undefined4 param_1,int *param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  *(byte *)(iVar3 + 0xe5) = *(char *)(iVar3 + 0xe5) + 1U & 3;
  if (*(code **)(iVar3 + 0xc) != (code *)0x0) {
    (**(code **)(iVar3 + 0xc))(*param_2,iVar3,0x772,*(undefined4 *)(iVar3 + 0x10));
    iVar1 = extraout_r1;
  }
  if (*(int *)(iVar3 + (uint)*(byte *)(iVar3 + 0xe5) * 8 + 0xb4) == 0) {
    iVar2 = *param_2;
    *(uint *)(iVar2 + 0x88) = *(uint *)(iVar2 + 0x88) & 0xffe3fffe;
