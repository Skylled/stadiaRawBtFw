// 600cb030  mpu__600cb030  size=440 bytes
// src: mpu.cc
// --- callers ---
...

{
  ...
  int iVar12;
  uint uVar13;
  undefined4 local_a0 [33];
  
  thunk_EXT_FUN_0000b5ba(local_a0,0,0x80);
  iVar7 = DAT_600cb1e8;
  uVar10 = 0;
  ...
  *(uint *)(iVar7 + 0x24) = *(uint *)(iVar7 + 0x24) & 0xfffeffff;
  ...
  iVar7 = gotham_16mb_mimxrt10xx_mpu__6006f660(DAT_600cb1f0,local_a0);
  uVar4 = DAT_600cb1fc;
  uVar3 = DAT_600cb1f8;
  for (iVar12 = 0; iVar12 != iVar7; iVar12 = iVar12 + 1) {
    cVar5 = FUN_600cafec(iVar12,local_a0[iVar12 * 2],local_a0[iVar12 * 2 + 1]);
    if (cVar5 != '\0') {
      bVar1 = (bool)isCurrentModePrivileged();
      if (bVar1) {
        enableIRQinterrupts((uVar10 & 1) == 1);
