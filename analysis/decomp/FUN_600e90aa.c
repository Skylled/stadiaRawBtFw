// 600e90aa  FUN_600e90aa  size=316 bytes
// --- callers ---
...
void FUN_600e90aa(undefined4 *param_1,uint *param_2)

{
  ...
  *param_1 = (int)uVar1;
  ...
  uVar1 = (ulonglong)param_2[3] * (ulonglong)param_2[2] + (ulonglong)(uVar5 + uVar4);
  uVar5 = (uint)(uVar1 >> 0x20);
  uVar4 = uVar6 + uVar5;
  uVar5 = (uint)CARRY4(uVar6,uVar5);
  ...
  lVar2 = (ulonglong)param_2[3] * (ulonglong)param_2[3] + (ulonglong)(uVar4 + uVar7);
  param_1[6] = (int)lVar2;
  param_1[7] = uVar5 + (int)((ulonglong)lVar2 >> 0x20);
  return;
}
