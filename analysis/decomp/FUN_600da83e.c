// 600da83e  FUN_600da83e  size=270 bytes
// --- callers ---
// --- callees ---
//   600da824 FUN_600da824


undefined4 *
FUN_600da83e(undefined4 *param_1,int *param_2,int param_3,int param_4,undefined4 param_5)

{
  ...
  do {
    ...
    if (param_3 == iVar6) goto LAB_600da88a;
...
LAB_600da88a:
  if ((param_3 == *piVar4) && (piVar4 != (int *)(iVar3 + 0x24))) {
    ...
    for (iVar2 = 0; iVar2 != piVar4[2]; iVar2 = iVar2 + 1) {
      if (*piVar7 == param_4) goto LAB_600da8c4;
      piVar7 = piVar7 + 4;
    }
    ...
    if (local_28 == '\0') {
      for (iVar2 = 0; iVar2 != ((int *)param_2[0x1b])[1]; iVar2 = iVar2 + 1) {
        ...
        if (*(int *)(iVar3 + iVar2 * 0x10) == param_4) goto LAB_600da8c4;
      }
...
LAB_600da89e:
  *(undefined1 *)((int)param_1 + 10) = local_2e;
  return param_1;
LAB_600da8c4:
  FUN_600da824(&local_38,piVar7 + 1);
  pcVar5 = *(code **)(*param_2 + 0x28);
  FUN_600da824(auStack_2c,&local_38);
