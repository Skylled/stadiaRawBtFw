// 600d382e  FUN_600d382e  size=90 bytes
// --- callers ---
...
uint FUN_600d382e(undefined4 param_1,undefined4 param_2,undefined4 param_3,uint param_4)

{
  ...
  iVar2 = FUN_600d6e14();
  if (iVar2 == 0) {
    uVar5 = keys__60066070(param_1,param_2,4);
  }
  else {
    ...
    if (uVar5 == 0) {
      if (uStack_14._2_2_ == 4) {
        bVar1 = key_value_store__600cb598(uVar3,uVar4,param_2,4,0);
        uVar5 = (uint)bVar1;
      }
      else {
        uVar5 = 3;
