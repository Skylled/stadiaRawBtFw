// 600d6fd8  FUN_600d6fd8  size=90 bytes
// --- callers ---
...
uint FUN_600d6fd8(undefined4 param_1,undefined4 param_2,undefined4 param_3,uint param_4)

{
  ...
  iVar2 = FUN_600d6e14();
  if (iVar2 == 0) {
    uVar5 = keys__60066070(param_1,param_2,8);
  }
  else {
    ...
    uVar5 = (uint)bVar1;
    if (uVar5 == 0) {
      if (uStack_14._2_2_ == 8) {
        bVar1 = key_value_store__600cb598(uVar3,uVar4,param_2,8,0);
        uVar5 = (uint)bVar1;
      }
      else {
        uVar5 = 3;
