// 600d4cae  FUN_600d4cae  size=128 bytes
// --- callers ---
...
undefined4 FUN_600d4cae(char *param_1,uint param_2)

{
  ...
  if (((param_1[0x38] == '\0') || (*param_1 == '\0')) || (param_1[1] == '\0')) {
    uVar4 = 9;
  }
    ...
    FUN_600cf548(uVar4,uVar2,0,3,param_2 & 0xff);
