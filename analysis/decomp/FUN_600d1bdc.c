// 600d1bdc  FUN_600d1bdc  size=60 bytes
// --- callers ---
...
undefined4
FUN_600d1bdc(int param_1,uint param_2,undefined4 param_3,int param_4,int param_5,short param_6,
...

{
  ...
  if ((param_1 == 0) || (*(int *)(param_1 + 0x4c) == 0)) {
    ...
    uVar1 = FUN_600558b8(param_1,0x21,param_3,param_2 | param_4 << 8,
