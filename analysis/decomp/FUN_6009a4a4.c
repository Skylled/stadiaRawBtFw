// 6009a4a4  FUN_6009a4a4  size=192 bytes
// --- callers ---
...
void FUN_6009a4a4(char *param_1)

{
  ...
  local_14 = *(code **)(DAT_6009a564 + 0x78c);
  local_c = DAT_6009a568;
  FUN_600aa3cc(DAT_6009a56c);
  *(undefined4 *)(DAT_6009a564 + 0x78c) = 0;
