// 600fba06  FUN_600fba06  size=150 bytes
// --- callers ---
// --- callees ---
...
void FUN_600fba06(int param_1,int param_2)

{
  ...
  if (iVar1 == 0) {
    ...
    *(undefined1 *)(param_1 + 0x24) = local_9;
