// 600b23d0  FUN_600b23d0  size=160 bytes
// --- callers ---
...
undefined4 FUN_600b23d0(int param_1,int param_2)

{
  ...
  iVar1 = FUN_6006dbac(0x21,DAT_600b2470,0x143);
  if (iVar1 == 0) {
    uVar2 = 0;
  }
  else {
    *(undefined2 *)(iVar1 + 2) = 0x19;
    *(undefined2 *)(iVar1 + 4) = 0;
    *(undefined1 *)(iVar1 + 8) = 0xb;
    *(undefined1 *)(iVar1 + 9) = 4;
    *(undefined1 *)(iVar1 + 10) = 0x16;
    ...
    for (iVar3 = 0; iVar3 < 0x10; iVar3 = iVar3 + 1) {
      *local_14 = *(undefined1 *)((0xf - iVar3) + param_2);
      local_14 = local_14 + 1;
    }
