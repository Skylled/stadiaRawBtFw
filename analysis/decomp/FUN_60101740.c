// 60101740  FUN_60101740  size=32 bytes
// --- callers ---
...
undefined4 * FUN_60101740(undefined4 *param_1)

{
  FUN_601016f0(0x32,*param_1,param_1[1],param_1 + 2);
  FUN_600cc124(param_1[2],*param_1,param_1[1]);
  return param_1;
}
