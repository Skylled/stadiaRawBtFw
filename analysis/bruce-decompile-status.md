...
**Snapshot: 2026-08-18 (full regeneration, session 151 / Wave 121).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 151 (3622 decomp files, 3622 in-census). Decompiled in-census functions grew to **3622** (530,128 bytes, 74.17% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,622 | 65.04% | 530,128 | 74.17% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,622 | 65.04% | 530,128 | **74.17%** |
| **Totally unknown** (no attribution, no decompile) | 1,947 | 34.96% | 184,595 | **25.83%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 1,947 | 34.96% | 184,595 | 25.83% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **1,947** | **34.96%** | **184,595** | **25.83%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97911 | 1049 | 656 | 29.7% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,622 | 530,128 |
...
| **Understood in some way (union)** | **3,622 (65.0%)** | **530,128 (74.2%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 1,947 (35.0%), or **1,947 (35.0%) excluding BTA-identified** | 184,595 (25.8%), or **184,595 (25.8%) excluding BTA-identified** |
