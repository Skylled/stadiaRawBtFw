...
**Snapshot: 2026-08-18 (full regeneration, session 134 / Wave 104).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 134 (3417 decomp files, 3417 in-census). Decompiled in-census functions grew to **3417** (505,362 bytes, 70.72% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,417 | 61.39% | 505,362 | 70.72% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,417 | 61.39% | 505,362 | **70.72%** |
| **Totally unknown** (no attribution, no decompile) | 2,149 | 38.61% | 209,239 | **29.28%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,149 | 38.61% | 209,239 | 29.28% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,149** | **38.61%** | **209,239** | **29.28%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97789 | 1046 | 451 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,417 | 505,362 |
...
| **Understood in some way (union)** | **3,417 (61.4%)** | **505,362 (70.7%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,149 (38.6%), or **2,149 (38.6%) excluding BTA-identified** | 209,239 (29.3%), or **209,239 (29.3%) excluding BTA-identified** |
