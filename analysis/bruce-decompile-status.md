...
**Snapshot: 2026-08-18 (full regeneration, session 125 / Wave 95).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 125 (3308 decomp files, 3308 in-census). Decompiled in-census functions grew to **3308** (490,238 bytes, 68.60% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,308 | 59.43% | 490,238 | 68.60% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,308 | 59.43% | 490,238 | **68.60%** |
| **Totally unknown** (no attribution, no decompile) | 2,258 | 40.57% | 224,363 | **31.40%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,258 | 40.57% | 224,363 | 31.40% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,258** | **40.57%** | **224,363** | **31.40%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97789 | 1046 | 342 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,308 | 490,238 |
...
| **Understood in some way (union)** | **3,308 (59.4%)** | **490,238 (68.6%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,258 (40.6%), or **2,258 (40.6%) excluding BTA-identified** | 224,363 (31.4%), or **224,363 (31.4%) excluding BTA-identified** |
