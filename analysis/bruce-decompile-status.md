...
**Snapshot: 2026-08-18 (full regeneration, session 122 / Wave 92).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 122 (3257 decomp files, 3257 in-census). Decompiled in-census functions grew to **3257** (485,904 bytes, 68.00% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,257 | 58.52% | 485,904 | 68.00% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,257 | 58.52% | 485,904 | **68.00%** |
| **Totally unknown** (no attribution, no decompile) | 2,309 | 41.48% | 228,697 | **32.00%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,309 | 41.48% | 228,697 | 32.00% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,309** | **41.48%** | **228,697** | **32.00%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97789 | 1046 | 291 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,257 | 485,904 |
...
| **Understood in some way (union)** | **3,257 (58.5%)** | **485,904 (68.0%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,309 (41.5%), or **2,309 (41.5%) excluding BTA-identified** | 228,697 (32.0%), or **228,697 (32.0%) excluding BTA-identified** |
