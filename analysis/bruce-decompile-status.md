...
**Snapshot: 2026-08-18 (full regeneration, session 119 / Wave 89).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 119 (3213 decomp files, 3213 in-census). Decompiled in-census functions grew to **3213** (482,434 bytes, 67.51% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,213 | 57.73% | 482,434 | 67.51% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,213 | 57.73% | 482,434 | **67.51%** |
| **Totally unknown** (no attribution, no decompile) | 2,353 | 42.27% | 232,167 | **32.49%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,353 | 42.27% | 232,167 | 32.49% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,353** | **42.27%** | **232,167** | **32.49%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97789 | 1046 | 247 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,213 | 482,434 |
...
| **Understood in some way (union)** | **3,213 (57.7%)** | **482,434 (67.5%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,353 (42.3%), or **2,353 (42.3%) excluding BTA-identified** | 232,167 (32.5%), or **232,167 (32.5%) excluding BTA-identified** |
