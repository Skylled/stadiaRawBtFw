...
**Snapshot: 2026-08-18 (full regeneration, session 130 / Wave 100).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 130 (3366 decomp files, 3366 in-census). Decompiled in-census functions grew to **3366** (499,106 bytes, 69.84% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,366 | 60.47% | 499,106 | 69.84% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,366 | 60.47% | 499,106 | **69.84%** |
| **Totally unknown** (no attribution, no decompile) | 2,200 | 39.53% | 215,495 | **30.16%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,200 | 39.53% | 215,495 | 30.16% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,200** | **39.53%** | **215,495** | **30.16%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97789 | 1046 | 400 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,366 | 499,106 |
...
| **Understood in some way (union)** | **3,366 (60.5%)** | **499,106 (69.8%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,200 (39.5%), or **2,200 (39.5%) excluding BTA-identified** | 215,495 (30.2%), or **215,495 (30.2%) excluding BTA-identified** |
