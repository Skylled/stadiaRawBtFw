...
**Snapshot: 2026-08-17 (full regeneration, session 35 / Wave 5).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 35 (1730 decomp files, 1588 in-census). Decompiled in-census functions grew to **1588** (348,405 bytes, 52.74% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 1,588 | 31.79% | 348,405 | 52.74% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 1,588 | 31.79% | 348,405 | **52.74%** |
| **Totally unknown** (no attribution, no decompile) | 3,407 | 68.21% | 312,165 | **47.26%** |
...
| — decompiled (also counted in §1's "Decompiled" row) | 952 | 191,305 | 93.6% |
| — **identified but not yet decompiled** | 124 | 13,144 | 6.4% |

Netting this out against §1's "Totally unknown" row gives the true unidentified figure:

| | Functions | % of 4,995 | Bytes | % of 660,570 |
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 3,407 | 68.21% | 312,165 | 47.26% |
| — of which: BTA-identified, module known, just not decompiled | 124 | 2.48% | 13,144 | 1.99% |
...
|---:|---|---|---:|---:|---:|---:|---:|---|
| 1★ | `0x600921b8` | `0x600c9cc4` | 228108 | 204449 | 1076 | 952 | 93.6% | `FUN_600ba1c4` (3898B @ `600ba1c4`) |
...
| Decompiled (in census) | 1,588 | 348,405 |
| — of which both attributed AND decompiled | 448 | 97,450 |
| — of which in the identified-but-not-formally-attributed BTA/BTE stack (§1a) | 952 | 191,305 |
| **Understood in some way (union)** | **1,588 (31.8%)** | **348,405 (52.7%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 3,407 (68.2%), or **3,283 (65.7%) excluding BTA-identified** | 312,165 (47.3%), or **299,021 (45.3%) excluding BTA-identified** |
