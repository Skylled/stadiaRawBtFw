...
**Snapshot: 2026-08-18 (full regeneration, session 172 / Wave 142).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 172 (4032 decomp files, 4032 in-census). Decompiled in-census functions grew to **4032** (557,806 bytes, 78.04% of code), with **139 of 139** attributed source files fully decompiled.

## 1. Top-line stats

| Metric | Functions | % of 5,630 | Bytes | % of 714,741 |
|---|---:|---:|---:|---:|
| **Total functions (census)** | 5,630 | 100% | 714,741 | 100% |
| **Attributed** (leaked `__FILE__` → 139 src files) | 448 | 7.96% | 95,682 | 13.39% |
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 4,032 | 71.62% | 557,806 | 78.04% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 4,032 | 71.62% | 557,806 | **78.04%** |
| **Totally unknown** (no attribution, no decompile) | 1,598 | 28.38% | 156,935 | **21.96%** |
...
| | Functions | % of 5,630 | Bytes | % of 714,741 |
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 1,598 | 28.38% | 156,935 | 21.96% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **1,598** | **28.38%** | **156,935** | **21.96%** |
...
| 11 | `0x600d56b8` | `0x600d89ec` | 13108 | 10928 | 205 | 52 | 83.4% | `FUN_600d80f4` (260B @ `600d80f4`) |
...
| Decompiled (in census) | 4,032 | 557,806 |
...
| **Understood in some way (union)** | **4,032 (71.6%)** | **557,806 (78.0%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 1,598 (28.4%), or **1,598 (28.4%) excluding BTA-identified** | 156,935 (22.0%), or **156,935 (22.0%) excluding BTA-identified** |
