...
**Snapshot: 2026-08-18 (full regeneration, session 52 / Wave 22).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 52 (1955 decomp files, 1955 in-census). Decompiled in-census functions grew to **1955** (389,790 bytes, 54.46% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 1,955 | 35.30% | 389,790 | 54.46% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 1,955 | 35.30% | 389,790 | **54.46%** |
| **Totally unknown** (no attribution, no decompile) | 3,584 | 64.70% | 325,995 | **45.54%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 3,584 | 64.70% | 325,995 | 45.54% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **3,584** | **64.70%** | **325,995** | **45.54%** |
...
| Decompiled (in census) | 1,955 | 389,790 |
...
| **Understood in some way (union)** | **1,955 (35.3%)** | **389,790 (54.5%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 3,584 (64.7%), or **3,584 (64.7%) excluding BTA-identified** | 325,995 (45.5%), or **325,995 (45.5%) excluding BTA-identified** |
