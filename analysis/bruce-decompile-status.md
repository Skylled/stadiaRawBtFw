...
**Snapshot: 2026-08-18 (full regeneration, session 98 / Wave 68).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 98 (2874 decomp files, 2874 in-census). Decompiled in-census functions grew to **2874** (455,384 bytes, 63.70% of code), with **139 of 139** attributed source files fully decompiled.

## 1. Top-line stats

| Metric | Functions | % of 5,540 | Bytes | % of 714,867 |
|---|---:|---:|---:|---:|
| **Total functions (census)** | 5,540 | 100% | 714,867 | 100% |
| **Attributed** (leaked `__FILE__` → 139 src files) | 448 | 8.09% | 97,422 | 13.63% |
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 2,874 | 51.88% | 455,384 | 63.70% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 2,874 | 51.88% | 455,384 | **63.70%** |
| **Totally unknown** (no attribution, no decompile) | 2,666 | 48.12% | 259,483 | **36.30%** |
...
| | Functions | % of 5,540 | Bytes | % of 714,867 |
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,666 | 48.12% | 259,483 | 36.30% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,666** | **48.12%** | **259,483** | **36.30%** |
...
| 3† | `0x600df286` | `0x600ea868` | 46562 | 44670 | 333 | 320 | 95.9% | `FUN_600e398a` (6270B @ `600e398a`) |
...
Of **5,540 total functions** (the current census):

| | Functions | Bytes |
|---|---:|---:|
| Attributed to a source file | 448 | 97,422 |
| Decompiled (in census) | 2,874 | 455,384 |
...
| **Understood in some way (union)** | **2,874 (51.9%)** | **455,384 (63.7%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,666 (48.1%), or **2,666 (48.1%) excluding BTA-identified** | 259,483 (36.3%), or **259,483 (36.3%) excluding BTA-identified** |
