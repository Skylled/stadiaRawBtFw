...
**Snapshot: 2026-08-18 (full regeneration, session 147 / Wave 117).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 147 (3564 decomp files, 3564 in-census). Decompiled in-census functions grew to **3564** (525,148 bytes, 73.48% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,564 | 64.02% | 525,148 | 73.48% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,564 | 64.02% | 525,148 | **73.48%** |
| **Totally unknown** (no attribution, no decompile) | 2,003 | 35.98% | 189,529 | **26.52%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,003 | 35.98% | 189,529 | 26.52% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,003** | **35.98%** | **189,529** | **26.52%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97865 | 1047 | 598 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,564 | 525,148 |
...
| **Understood in some way (union)** | **3,564 (64.0%)** | **525,148 (73.5%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,003 (36.0%), or **2,003 (36.0%) excluding BTA-identified** | 189,529 (26.5%), or **189,529 (26.5%) excluding BTA-identified** |
