...
**Snapshot: 2026-08-17 (full regeneration, session 36 / Wave 6).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 36 (1745 decomp files, 1603 in-census). Decompiled in-census functions grew to **1603** (350,213 bytes, 53.02% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 1,603 | 32.09% | 350,213 | 53.02% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 1,603 | 32.09% | 350,213 | **53.02%** |
| **Totally unknown** (no attribution, no decompile) | 3,392 | 67.91% | 310,357 | **46.98%** |
...
| — decompiled (also counted in §1's "Decompiled" row) | 967 | 193,113 | 94.5% |
| — **identified but not yet decompiled** | 109 | 11,336 | 5.5% |

Netting this out against §1's "Totally unknown" row gives the true unidentified figure:

| | Functions | % of 4,995 | Bytes | % of 660,570 |
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 3,392 | 67.91% | 310,357 | 46.98% |
| — of which: BTA-identified, module known, just not decompiled | 109 | 2.18% | 11,336 | 1.72% |
...
|---:|---|---|---:|---:|---:|---:|---:|---|
| 1★ | `0x600921b8` | `0x600c9cc4` | 228108 | 204449 | 1076 | 967 | 94.5% | `FUN_600ba1c4` (3898B @ `600ba1c4`) |
...
| Decompiled (in census) | 1,603 | 350,213 |
| — of which both attributed AND decompiled | 448 | 97,450 |
| — of which in the identified-but-not-formally-attributed BTA/BTE stack (§1a) | 967 | 193,113 |
| **Understood in some way (union)** | **1,603 (32.1%)** | **350,213 (53.0%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 3,392 (67.9%), or **3,283 (65.7%) excluding BTA-identified** | 310,357 (47.0%), or **299,021 (45.3%) excluding BTA-identified** |
