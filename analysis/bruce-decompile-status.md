...
**Snapshot: 2026-08-18 (full regeneration, session 95 / Wave 65).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 95 (2814 decomp files, 2814 in-census). Decompiled in-census functions grew to **2814** (447,000 bytes, 62.54% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 2,814 | 50.81% | 447,000 | 62.54% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 2,814 | 50.81% | 447,000 | **62.54%** |
| **Totally unknown** (no attribution, no decompile) | 2,724 | 49.19% | 267,765 | **37.46%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,724 | 49.19% | 267,765 | 37.46% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,724** | **49.19%** | **267,765** | **37.46%** |
...
| 3† | `0x600df286` | `0x600ea868` | 46562 | 44568 | 331 | 260 | 95.7% | `FUN_600e398a` (6270B @ `600e398a`) |
...
| Decompiled (in census) | 2,814 | 447,000 |
...
| **Understood in some way (union)** | **2,814 (50.8%)** | **447,000 (62.5%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,724 (49.2%), or **2,724 (49.2%) excluding BTA-identified** | 267,765 (37.5%), or **267,765 (37.5%) excluding BTA-identified** |
