...
**Snapshot: 2026-08-18 (full regeneration, session 124 / Wave 94).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 124 (3292 decomp files, 3292 in-census). Decompiled in-census functions grew to **3292** (488,730 bytes, 68.39% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,292 | 59.14% | 488,730 | 68.39% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,292 | 59.14% | 488,730 | **68.39%** |
| **Totally unknown** (no attribution, no decompile) | 2,274 | 40.86% | 225,871 | **31.61%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,274 | 40.86% | 225,871 | 31.61% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,274** | **40.86%** | **225,871** | **31.61%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97789 | 1046 | 326 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,292 | 488,730 |
...
| **Understood in some way (union)** | **3,292 (59.1%)** | **488,730 (68.4%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,274 (40.9%), or **2,274 (40.9%) excluding BTA-identified** | 225,871 (31.6%), or **225,871 (31.6%) excluding BTA-identified** |
