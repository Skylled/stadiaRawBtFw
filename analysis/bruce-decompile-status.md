...
**Snapshot: 2026-08-18 (full regeneration, session 173 / Wave 143).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 173 (4052 decomp files, 4052 in-census). Decompiled in-census functions grew to **4052** (559,652 bytes, 78.30% of code), with **139 of 139** attributed source files fully decompiled.

## 1. Top-line stats

| Metric | Functions | % of 5,630 | Bytes | % of 714,759 |
|---|---:|---:|---:|---:|
| **Total functions (census)** | 5,630 | 100% | 714,759 | 100% |
| **Attributed** (leaked `__FILE__` → 139 src files) | 448 | 7.96% | 95,682 | 13.39% |
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 4,052 | 71.97% | 559,652 | 78.30% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 4,052 | 71.97% | 559,652 | **78.30%** |
| **Totally unknown** (no attribution, no decompile) | 1,578 | 28.03% | 155,107 | **21.70%** |
...
| | Functions | % of 5,630 | Bytes | % of 714,759 |
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 1,578 | 28.03% | 155,107 | 21.70% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **1,578** | **28.03%** | **155,107** | **21.70%** |
...
| 11 | `0x600d56b8` | `0x600d89ec` | 13108 | 10946 | 205 | 72 | 83.5% | `FUN_600d80f4` (260B @ `600d80f4`) |
...
Of **5,630 total functions** (the current census):

| | Functions | Bytes |
|---|---:|---:|
| Attributed to a source file | 448 | 95,682 |
| Decompiled (in census) | 4,052 | 559,652 |
...
| **Understood in some way (union)** | **4,052 (72.0%)** | **559,652 (78.3%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 1,578 (28.0%), or **1,578 (28.0%) excluding BTA-identified** | 155,107 (21.7%), or **155,107 (21.7%) excluding BTA-identified** |
