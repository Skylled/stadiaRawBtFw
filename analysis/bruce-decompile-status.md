...
**Snapshot: 2026-08-18 (full regeneration, session 155 / Wave 125).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 155 (3670 decomp files, 3670 in-census). Decompiled in-census functions grew to **3670** (535,782 bytes, 74.95% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,670 | 65.89% | 535,782 | 74.95% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,670 | 65.89% | 535,782 | **74.95%** |
| **Totally unknown** (no attribution, no decompile) | 1,900 | 34.11% | 179,079 | **25.05%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 1,900 | 34.11% | 179,079 | 25.05% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **1,900** | **34.11%** | **179,079** | **25.05%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 98049 | 1050 | 704 | 29.7% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,670 | 535,782 |
...
| **Understood in some way (union)** | **3,670 (65.9%)** | **535,782 (74.9%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 1,900 (34.1%), or **1,900 (34.1%) excluding BTA-identified** | 179,079 (25.1%), or **179,079 (25.1%) excluding BTA-identified** |
