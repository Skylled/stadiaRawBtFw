...
**Snapshot: 2026-08-17 (full regeneration, session 39 / Wave 9).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 39 (1790 decomp files, 1648 in-census). Decompiled in-census functions grew to **1648** (354,909 bytes, 53.73% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 1,648 | 32.99% | 354,909 | 53.73% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 1,648 | 32.99% | 354,909 | **53.73%** |
| **Totally unknown** (no attribution, no decompile) | 3,347 | 67.01% | 305,661 | **46.27%** |
...
| — decompiled (also counted in §1's "Decompiled" row) | 1,012 | 197,809 | 96.8% |
| — **identified but not yet decompiled** | 64 | 6,640 | 3.2% |

Netting this out against §1's "Totally unknown" row gives the true unidentified figure:

| | Functions | % of 4,995 | Bytes | % of 660,570 |
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 3,347 | 67.01% | 305,661 | 46.27% |
| — of which: BTA-identified, module known, just not decompiled | 64 | 1.28% | 6,640 | 1.01% |
...
|---:|---|---|---:|---:|---:|---:|---:|---|
| 1★ | `0x600921b8` | `0x600c9cc4` | 228108 | 204449 | 1076 | 1012 | 96.8% | `FUN_600ba1c4` (3898B @ `600ba1c4`) |
...
| Decompiled (in census) | 1,648 | 354,909 |
| — of which both attributed AND decompiled | 448 | 97,450 |
| — of which in the identified-but-not-formally-attributed BTA/BTE stack (§1a) | 1,012 | 197,809 |
| **Understood in some way (union)** | **1,648 (33.0%)** | **354,909 (53.7%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 3,347 (67.0%), or **3,283 (65.7%) excluding BTA-identified** | 305,661 (46.3%), or **299,021 (45.3%) excluding BTA-identified** |
