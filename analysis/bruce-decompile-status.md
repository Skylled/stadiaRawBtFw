...
**Snapshot: 2026-08-18 (full regeneration, session 144 / Wave 114).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 144 (3524 decomp files, 3524 in-census). Decompiled in-census functions grew to **3524** (521,118 bytes, 72.92% of code), with **139 of 139** attributed source files fully decompiled.

## 1. Top-line stats

| Metric | Functions | % of 5,565 | Bytes | % of 714,633 |
|---|---:|---:|---:|---:|
| **Total functions (census)** | 5,565 | 100% | 714,633 | 100% |
| **Attributed** (leaked `__FILE__` → 139 src files) | 448 | 8.05% | 96,312 | 13.48% |
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,524 | 63.32% | 521,118 | 72.92% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,524 | 63.32% | 521,118 | **72.92%** |
| **Totally unknown** (no attribution, no decompile) | 2,041 | 36.68% | 193,515 | **27.08%** |
...
| | Functions | % of 5,565 | Bytes | % of 714,633 |
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,041 | 36.68% | 193,515 | 27.08% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,041** | **36.68%** | **193,515** | **27.08%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97821 | 1045 | 558 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
Of **5,565 total functions** (the current census):

| | Functions | Bytes |
|---|---:|---:|
| Attributed to a source file | 448 | 96,312 |
| Decompiled (in census) | 3,524 | 521,118 |
...
| **Understood in some way (union)** | **3,524 (63.3%)** | **521,118 (72.9%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,041 (36.7%), or **2,041 (36.7%) excluding BTA-identified** | 193,515 (27.1%), or **193,515 (27.1%) excluding BTA-identified** |
