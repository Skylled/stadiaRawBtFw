...
**Snapshot: 2026-08-18 (full regeneration, session 112 / Wave 82).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 112 (3127 decomp files, 3127 in-census). Decompiled in-census functions grew to **3127** (473,646 bytes, 66.28% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,127 | 56.18% | 473,646 | 66.28% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,127 | 56.18% | 473,646 | **66.28%** |
| **Totally unknown** (no attribution, no decompile) | 2,439 | 43.82% | 240,955 | **33.72%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,439 | 43.82% | 240,955 | 33.72% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,439** | **43.82%** | **240,955** | **33.72%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97789 | 1046 | 161 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,127 | 473,646 |
...
| **Understood in some way (union)** | **3,127 (56.2%)** | **473,646 (66.3%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,439 (43.8%), or **2,439 (43.8%) excluding BTA-identified** | 240,955 (33.7%), or **240,955 (33.7%) excluding BTA-identified** |
