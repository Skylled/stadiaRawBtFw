...
**Snapshot: 2026-08-18 (full regeneration, session 96 / Wave 66).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 96 (2834 decomp files, 2834 in-census). Decompiled in-census functions grew to **2834** (451,234 bytes, 63.13% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 2,834 | 51.17% | 451,234 | 63.13% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 2,834 | 51.17% | 451,234 | **63.13%** |
| **Totally unknown** (no attribution, no decompile) | 2,704 | 48.83% | 263,531 | **36.87%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,704 | 48.83% | 263,531 | 36.87% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,704** | **48.83%** | **263,531** | **36.87%** |
...
| 3† | `0x600df286` | `0x600ea868` | 46562 | 44568 | 331 | 280 | 95.7% | `FUN_600e398a` (6270B @ `600e398a`) |
...
| Decompiled (in census) | 2,834 | 451,234 |
...
| **Understood in some way (union)** | **2,834 (51.2%)** | **451,234 (63.1%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,704 (48.8%), or **2,704 (48.8%) excluding BTA-identified** | 263,531 (36.9%), or **263,531 (36.9%) excluding BTA-identified** |
