...
**Snapshot: 2026-08-18 (full regeneration, session 145 / Wave 115).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 145 (3536 decomp files, 3536 in-census). Decompiled in-census functions grew to **3536** (522,776 bytes, 73.15% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,536 | 63.54% | 522,776 | 73.15% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,536 | 63.54% | 522,776 | **73.15%** |
| **Totally unknown** (no attribution, no decompile) | 2,029 | 36.46% | 191,857 | **26.85%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,029 | 36.46% | 191,857 | 26.85% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,029** | **36.46%** | **191,857** | **26.85%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97821 | 1045 | 570 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,536 | 522,776 |
...
| **Understood in some way (union)** | **3,536 (63.5%)** | **522,776 (73.2%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,029 (36.5%), or **2,029 (36.5%) excluding BTA-identified** | 191,857 (26.8%), or **191,857 (26.8%) excluding BTA-identified** |
