...
**Snapshot: 2026-08-18 (full regeneration, session 85 / Wave 55).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 85 (2614 decomp files, 2614 in-census). Decompiled in-census functions grew to **2614** (426,316 bytes, 59.60% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 2,614 | 47.20% | 426,316 | 59.60% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 2,614 | 47.20% | 426,316 | **59.60%** |
| **Totally unknown** (no attribution, no decompile) | 2,924 | 52.80% | 288,939 | **40.40%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,924 | 52.80% | 288,939 | 40.40% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,924** | **52.80%** | **288,939** | **40.40%** |
...
| 3† | `0x600df286` | `0x600ea868` | 46562 | 44824 | 331 | 60 | 96.3% | `FUN_600e398a` (6270B @ `600e398a`) |
...
| Decompiled (in census) | 2,614 | 426,316 |
...
| **Understood in some way (union)** | **2,614 (47.2%)** | **426,316 (59.6%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,924 (52.8%), or **2,924 (52.8%) excluding BTA-identified** | 288,939 (40.4%), or **288,939 (40.4%) excluding BTA-identified** |
