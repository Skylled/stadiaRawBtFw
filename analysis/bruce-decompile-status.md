...
**Snapshot: 2026-08-18 (full regeneration, session 71 / Wave 41).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 71 (2334 decomp files, 2334 in-census). Decompiled in-census functions grew to **2334** (409,310 bytes, 57.19% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 2,334 | 42.14% | 409,310 | 57.19% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 2,334 | 42.14% | 409,310 | **57.19%** |
| **Totally unknown** (no attribution, no decompile) | 3,205 | 57.86% | 306,349 | **42.81%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 3,205 | 57.86% | 306,349 | 42.81% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **3,205** | **57.86%** | **306,349** | **42.81%** |
...
| 6† | `0x600d8a12` | `0x600df24c` | 26682 | 24368 | 432 | 166 | 91.3% | `FUN_600dcf8c` (984B @ `600dcf8c`) |
...
| Decompiled (in census) | 2,334 | 409,310 |
...
| **Understood in some way (union)** | **2,334 (42.1%)** | **409,310 (57.2%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 3,205 (57.9%), or **3,205 (57.9%) excluding BTA-identified** | 306,349 (42.8%), or **306,349 (42.8%) excluding BTA-identified** |
