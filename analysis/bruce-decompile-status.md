...
**Snapshot: 2026-08-18 (full regeneration, session 143 / Wave 113).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 143 (3512 decomp files, 3512 in-census). Decompiled in-census functions grew to **3512** (520,300 bytes, 72.81% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,512 | 63.10% | 520,300 | 72.81% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,512 | 63.10% | 520,300 | **72.81%** |
| **Totally unknown** (no attribution, no decompile) | 2,054 | 36.90% | 194,301 | **27.19%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,054 | 36.90% | 194,301 | 27.19% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,054** | **36.90%** | **194,301** | **27.19%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97789 | 1046 | 546 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,512 | 520,300 |
...
| **Understood in some way (union)** | **3,512 (63.1%)** | **520,300 (72.8%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,054 (36.9%), or **2,054 (36.9%) excluding BTA-identified** | 194,301 (27.2%), or **194,301 (27.2%) excluding BTA-identified** |
