...
**Snapshot: 2026-08-18 (full regeneration, session 90 / Wave 60).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 90 (2714 decomp files, 2714 in-census). Decompiled in-census functions grew to **2714** (433,170 bytes, 60.59% of code), with **139 of 139** attributed source files fully decompiled.

## 1. Top-line stats

| Metric | Functions | % of 5,538 | Bytes | % of 714,923 |
|---|---:|---:|---:|---:|
| **Total functions (census)** | 5,538 | 100% | 714,923 | 100% |
| **Attributed** (leaked `__FILE__` → 139 src files) | 448 | 8.09% | 97,450 | 13.63% |
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 2,714 | 49.01% | 433,170 | 60.59% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 2,714 | 49.01% | 433,170 | **60.59%** |
| **Totally unknown** (no attribution, no decompile) | 2,824 | 50.99% | 281,753 | **39.41%** |
...
| | Functions | % of 5,538 | Bytes | % of 714,923 |
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,824 | 50.99% | 281,753 | 39.41% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,824** | **50.99%** | **281,753** | **39.41%** |
...
| 3† | `0x600df286` | `0x600ea868` | 46562 | 44492 | 331 | 160 | 95.6% | `FUN_600e398a` (6270B @ `600e398a`) |
...
| Decompiled (in census) | 2,714 | 433,170 |
...
| **Understood in some way (union)** | **2,714 (49.0%)** | **433,170 (60.6%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,824 (51.0%), or **2,824 (51.0%) excluding BTA-identified** | 281,753 (39.4%), or **281,753 (39.4%) excluding BTA-identified** |
