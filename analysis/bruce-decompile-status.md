...
**Snapshot: 2026-08-18 (full regeneration, session 113 / Wave 83).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 113 (3139 decomp files, 3139 in-census). Decompiled in-census functions grew to **3139** (474,958 bytes, 66.46% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,139 | 56.40% | 474,958 | 66.46% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,139 | 56.40% | 474,958 | **66.46%** |
| **Totally unknown** (no attribution, no decompile) | 2,427 | 43.60% | 239,643 | **33.54%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,427 | 43.60% | 239,643 | 33.54% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,427** | **43.60%** | **239,643** | **33.54%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97789 | 1046 | 173 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,139 | 474,958 |
...
| **Understood in some way (union)** | **3,139 (56.4%)** | **474,958 (66.5%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,427 (43.6%), or **2,427 (43.6%) excluding BTA-identified** | 239,643 (33.5%), or **239,643 (33.5%) excluding BTA-identified** |
