...
**Snapshot: 2026-08-18 (full regeneration, session 116 / Wave 86).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 116 (3177 decomp files, 3177 in-census). Decompiled in-census functions grew to **3177** (478,224 bytes, 66.92% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,177 | 57.08% | 478,224 | 66.92% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,177 | 57.08% | 478,224 | **66.92%** |
| **Totally unknown** (no attribution, no decompile) | 2,389 | 42.92% | 236,377 | **33.08%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,389 | 42.92% | 236,377 | 33.08% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,389** | **42.92%** | **236,377** | **33.08%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97789 | 1046 | 211 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,177 | 478,224 |
...
| **Understood in some way (union)** | **3,177 (57.1%)** | **478,224 (66.9%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,389 (42.9%), or **2,389 (42.9%) excluding BTA-identified** | 236,377 (33.1%), or **236,377 (33.1%) excluding BTA-identified** |
