...
**Snapshot: 2026-08-18 (full regeneration, session 133 / Wave 103).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 133 (3402 decomp files, 3402 in-census). Decompiled in-census functions grew to **3402** (503,844 bytes, 70.51% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,402 | 61.12% | 503,844 | 70.51% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,402 | 61.12% | 503,844 | **70.51%** |
| **Totally unknown** (no attribution, no decompile) | 2,164 | 38.88% | 210,757 | **29.49%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,164 | 38.88% | 210,757 | 29.49% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,164** | **38.88%** | **210,757** | **29.49%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97789 | 1046 | 436 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,402 | 503,844 |
...
| **Understood in some way (union)** | **3,402 (61.1%)** | **503,844 (70.5%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,164 (38.9%), or **2,164 (38.9%) excluding BTA-identified** | 210,757 (29.5%), or **210,757 (29.5%) excluding BTA-identified** |
