...
**Snapshot: 2026-08-18 (full regeneration, session 97 / Wave 67).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 97 (2854 decomp files, 2854 in-census). Decompiled in-census functions grew to **2854** (452,920 bytes, 63.37% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 2,854 | 51.53% | 452,920 | 63.37% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 2,854 | 51.53% | 452,920 | **63.37%** |
| **Totally unknown** (no attribution, no decompile) | 2,684 | 48.47% | 261,845 | **36.63%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,684 | 48.47% | 261,845 | 36.63% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,684** | **48.47%** | **261,845** | **36.63%** |
...
| 3† | `0x600df286` | `0x600ea868` | 46562 | 44568 | 331 | 300 | 95.7% | `FUN_600e398a` (6270B @ `600e398a`) |
...
| Decompiled (in census) | 2,854 | 452,920 |
...
| **Understood in some way (union)** | **2,854 (51.5%)** | **452,920 (63.4%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,684 (48.5%), or **2,684 (48.5%) excluding BTA-identified** | 261,845 (36.6%), or **261,845 (36.6%) excluding BTA-identified** |
