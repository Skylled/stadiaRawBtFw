...
**Snapshot: 2026-08-18 (full regeneration, session 87 / Wave 57).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 87 (2654 decomp files, 2654 in-census). Decompiled in-census functions grew to **2654** (428,326 bytes, 59.89% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 2,654 | 47.92% | 428,326 | 59.89% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 2,654 | 47.92% | 428,326 | **59.89%** |
| **Totally unknown** (no attribution, no decompile) | 2,884 | 52.08% | 286,863 | **40.11%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,884 | 52.08% | 286,863 | 40.11% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,884** | **52.08%** | **286,863** | **40.11%** |
...
| 3† | `0x600df286` | `0x600ea868` | 46562 | 44758 | 331 | 100 | 96.1% | `FUN_600e398a` (6270B @ `600e398a`) |
...
| Decompiled (in census) | 2,654 | 428,326 |
...
| **Understood in some way (union)** | **2,654 (47.9%)** | **428,326 (59.9%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,884 (52.1%), or **2,884 (52.1%) excluding BTA-identified** | 286,863 (40.1%), or **286,863 (40.1%) excluding BTA-identified** |
