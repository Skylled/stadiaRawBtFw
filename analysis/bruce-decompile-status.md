...
**Snapshot: 2026-08-18 (full regeneration, session 111 / Wave 81).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 111 (3116 decomp files, 3116 in-census). Decompiled in-census functions grew to **3116** (471,820 bytes, 66.03% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,116 | 55.98% | 471,820 | 66.03% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,116 | 55.98% | 471,820 | **66.03%** |
| **Totally unknown** (no attribution, no decompile) | 2,450 | 44.02% | 242,781 | **33.97%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,450 | 44.02% | 242,781 | 33.97% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,450** | **44.02%** | **242,781** | **33.97%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97789 | 1046 | 150 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,116 | 471,820 |
...
| **Understood in some way (union)** | **3,116 (56.0%)** | **471,820 (66.0%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,450 (44.0%), or **2,450 (44.0%) excluding BTA-identified** | 242,781 (34.0%), or **242,781 (34.0%) excluding BTA-identified** |
