...
**Snapshot: 2026-08-18 (full regeneration, session 146 / Wave 116).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 146 (3549 decomp files, 3549 in-census). Decompiled in-census functions grew to **3549** (524,000 bytes, 73.32% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,549 | 63.77% | 524,000 | 73.32% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,549 | 63.77% | 524,000 | **73.32%** |
| **Totally unknown** (no attribution, no decompile) | 2,016 | 36.23% | 190,633 | **26.68%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,016 | 36.23% | 190,633 | 26.68% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,016** | **36.23%** | **190,633** | **26.68%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97821 | 1045 | 583 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,549 | 524,000 |
...
| **Understood in some way (union)** | **3,549 (63.8%)** | **524,000 (73.3%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,016 (36.2%), or **2,016 (36.2%) excluding BTA-identified** | 190,633 (26.7%), or **190,633 (26.7%) excluding BTA-identified** |
