...
**Snapshot: 2026-08-18 (full regeneration, session 123 / Wave 93).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 123 (3271 decomp files, 3271 in-census). Decompiled in-census functions grew to **3271** (487,862 bytes, 68.27% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,271 | 58.77% | 487,862 | 68.27% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,271 | 58.77% | 487,862 | **68.27%** |
| **Totally unknown** (no attribution, no decompile) | 2,295 | 41.23% | 226,739 | **31.73%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,295 | 41.23% | 226,739 | 31.73% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,295** | **41.23%** | **226,739** | **31.73%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97789 | 1046 | 305 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,271 | 487,862 |
...
| **Understood in some way (union)** | **3,271 (58.8%)** | **487,862 (68.3%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,295 (41.2%), or **2,295 (41.2%) excluding BTA-identified** | 226,739 (31.7%), or **226,739 (31.7%) excluding BTA-identified** |
