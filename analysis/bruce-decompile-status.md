...
**Snapshot: 2026-08-18 (full regeneration, session 115 / Wave 85).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 115 (3163 decomp files, 3163 in-census). Decompiled in-census functions grew to **3163** (477,220 bytes, 66.78% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,163 | 56.83% | 477,220 | 66.78% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,163 | 56.83% | 477,220 | **66.78%** |
| **Totally unknown** (no attribution, no decompile) | 2,403 | 43.17% | 237,381 | **33.22%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,403 | 43.17% | 237,381 | 33.22% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,403** | **43.17%** | **237,381** | **33.22%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97789 | 1046 | 197 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,163 | 477,220 |
...
| **Understood in some way (union)** | **3,163 (56.8%)** | **477,220 (66.8%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,403 (43.2%), or **2,403 (43.2%) excluding BTA-identified** | 237,381 (33.2%), or **237,381 (33.2%) excluding BTA-identified** |
