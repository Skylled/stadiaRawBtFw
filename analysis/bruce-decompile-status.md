...
**Snapshot: 2026-08-18 (full regeneration, session 81 / Wave 51).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 81 (2534 decomp files, 2534 in-census). Decompiled in-census functions grew to **2534** (421,996 bytes, 58.99% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 2,534 | 45.76% | 421,996 | 58.99% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 2,534 | 45.76% | 421,996 | **58.99%** |
| **Totally unknown** (no attribution, no decompile) | 3,004 | 54.24% | 293,323 | **41.01%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 3,004 | 54.24% | 293,323 | 41.01% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **3,004** | **54.24%** | **293,323** | **41.01%** |
...
| 6† | `0x600d8a12` | `0x600df24c` | 26682 | 24028 | 431 | 366 | 90.1% | `FUN_600dcf8c` (984B @ `600dcf8c`) |
...
| Decompiled (in census) | 2,534 | 421,996 |
...
| **Understood in some way (union)** | **2,534 (45.8%)** | **421,996 (59.0%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 3,004 (54.2%), or **3,004 (54.2%) excluding BTA-identified** | 293,323 (41.0%), or **293,323 (41.0%) excluding BTA-identified** |
