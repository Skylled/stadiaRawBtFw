...
**Snapshot: 2026-08-18 (full regeneration, session 67 / Wave 37).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 67 (2254 decomp files, 2254 in-census). Decompiled in-census functions grew to **2254** (405,642 bytes, 56.68% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 2,254 | 40.69% | 405,642 | 56.68% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 2,254 | 40.69% | 405,642 | **56.68%** |
| **Totally unknown** (no attribution, no decompile) | 3,285 | 59.31% | 310,089 | **43.32%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 3,285 | 59.31% | 310,089 | 43.32% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **3,285** | **59.31%** | **310,089** | **43.32%** |
...
| 6† | `0x600d8a12` | `0x600df24c` | 26682 | 24440 | 432 | 86 | 91.6% | `FUN_600dcf8c` (984B @ `600dcf8c`) |
...
| Decompiled (in census) | 2,254 | 405,642 |
...
| **Understood in some way (union)** | **2,254 (40.7%)** | **405,642 (56.7%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 3,285 (59.3%), or **3,285 (59.3%) excluding BTA-identified** | 310,089 (43.3%), or **310,089 (43.3%) excluding BTA-identified** |
