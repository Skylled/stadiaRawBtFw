...
**Snapshot: 2026-08-18 (full regeneration, session 142 / Wave 112).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 142 (3501 decomp files, 3501 in-census). Decompiled in-census functions grew to **3501** (518,784 bytes, 72.60% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,501 | 62.90% | 518,784 | 72.60% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,501 | 62.90% | 518,784 | **72.60%** |
| **Totally unknown** (no attribution, no decompile) | 2,065 | 37.10% | 195,817 | **27.40%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,065 | 37.10% | 195,817 | 27.40% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,065** | **37.10%** | **195,817** | **27.40%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97789 | 1046 | 535 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,501 | 518,784 |
...
| **Understood in some way (union)** | **3,501 (62.9%)** | **518,784 (72.6%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,065 (37.1%), or **2,065 (37.1%) excluding BTA-identified** | 195,817 (27.4%), or **195,817 (27.4%) excluding BTA-identified** |
