...
**Snapshot: 2026-08-17 (full regeneration, session 32 / Wave 2).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 32 (1682 decomp files, 1540 in-census). Decompiled in-census functions grew to **1540** (343,469 bytes, 52.00% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 1,540 | 30.83% | 343,469 | 52.00% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 1,540 | 30.83% | 343,469 | **52.00%** |
| **Totally unknown** (no attribution, no decompile) | 3,455 | 69.17% | 317,101 | **48.00%** |
...
| — decompiled (also counted in §1's "Decompiled" row) | 904 | 186,369 | 91.2% |
| — **identified but not yet decompiled** | 172 | 18,080 | 8.8% |

Netting this out against §1's "Totally unknown" row gives the true unidentified figure:

| | Functions | % of 4,995 | Bytes | % of 660,570 |
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 3,455 | 69.17% | 317,101 | 48.00% |
| — of which: BTA-identified, module known, just not decompiled | 172 | 3.44% | 18,080 | 2.74% |
...
|---:|---|---|---:|---:|---:|---:|---:|---|
| 1★ | `0x600921b8` | `0x600c9cc4` | 228108 | 204449 | 1076 | 904 | 91.2% | `FUN_600ba1c4` (3898B @ `600ba1c4`) |
...
| Decompiled (in census) | 1,540 | 343,469 |
| — of which both attributed AND decompiled | 448 | 97,450 |
| — of which in the identified-but-not-formally-attributed BTA/BTE stack (§1a) | 904 | 186,369 |
| **Understood in some way (union)** | **1,540 (30.8%)** | **343,469 (52.0%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 3,455 (69.2%), or **3,283 (65.7%) excluding BTA-identified** | 317,101 (48.0%), or **299,021 (45.3%) excluding BTA-identified** |
