...
**Snapshot: 2026-08-18 (full regeneration, session 131 / Wave 101).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 131 (3377 decomp files, 3377 in-census). Decompiled in-census functions grew to **3377** (500,664 bytes, 70.06% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,377 | 60.67% | 500,664 | 70.06% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,377 | 60.67% | 500,664 | **70.06%** |
| **Totally unknown** (no attribution, no decompile) | 2,189 | 39.33% | 213,937 | **29.94%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,189 | 39.33% | 213,937 | 29.94% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,189** | **39.33%** | **213,937** | **29.94%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97789 | 1046 | 411 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,377 | 500,664 |
...
| **Understood in some way (union)** | **3,377 (60.7%)** | **500,664 (70.1%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,189 (39.3%), or **2,189 (39.3%) excluding BTA-identified** | 213,937 (29.9%), or **213,937 (29.9%) excluding BTA-identified** |
