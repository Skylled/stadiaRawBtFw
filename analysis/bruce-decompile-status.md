...
**Snapshot: 2026-08-18 (full regeneration, session 107 / Wave 77).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 107 (3050 decomp files, 3050 in-census). Decompiled in-census functions grew to **3050** (466,700 bytes, 65.31% of code), with **139 of 139** attributed source files fully decompiled.

## 1. Top-line stats

| Metric | Functions | % of 5,562 | Bytes | % of 714,587 |
|---|---:|---:|---:|---:|
| **Total functions (census)** | 5,562 | 100% | 714,587 | 100% |
| **Attributed** (leaked `__FILE__` → 139 src files) | 448 | 8.05% | 96,312 | 13.48% |
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,050 | 54.84% | 466,700 | 65.31% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,050 | 54.84% | 466,700 | **65.31%** |
| **Totally unknown** (no attribution, no decompile) | 2,512 | 45.16% | 247,887 | **34.69%** |
...
| | Functions | % of 5,562 | Bytes | % of 714,587 |
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,512 | 45.16% | 247,887 | 34.69% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,512** | **45.16%** | **247,887** | **34.69%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97775 | 1042 | 84 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,050 | 466,700 |
...
| **Understood in some way (union)** | **3,050 (54.8%)** | **466,700 (65.3%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,512 (45.2%), or **2,512 (45.2%) excluding BTA-identified** | 247,887 (34.7%), or **247,887 (34.7%) excluding BTA-identified** |
