...
**Snapshot: 2026-08-18 (full regeneration, session 114 / Wave 84).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 114 (3149 decomp files, 3149 in-census). Decompiled in-census functions grew to **3149** (475,956 bytes, 66.60% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,149 | 56.58% | 475,956 | 66.60% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,149 | 56.58% | 475,956 | **66.60%** |
| **Totally unknown** (no attribution, no decompile) | 2,417 | 43.42% | 238,645 | **33.40%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,417 | 43.42% | 238,645 | 33.40% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,417** | **43.42%** | **238,645** | **33.40%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97789 | 1046 | 183 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,149 | 475,956 |
...
| **Understood in some way (union)** | **3,149 (56.6%)** | **475,956 (66.6%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,417 (43.4%), or **2,417 (43.4%) excluding BTA-identified** | 238,645 (33.4%), or **238,645 (33.4%) excluding BTA-identified** |
