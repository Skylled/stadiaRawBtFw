...
**Snapshot: 2026-08-18 (full regeneration, session 129 / Wave 99).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 129 (3356 decomp files, 3356 in-census). Decompiled in-census functions grew to **3356** (497,162 bytes, 69.57% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 3,356 | 60.29% | 497,162 | 69.57% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 3,356 | 60.29% | 497,162 | **69.57%** |
| **Totally unknown** (no attribution, no decompile) | 2,210 | 39.71% | 217,439 | **30.43%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,210 | 39.71% | 217,439 | 30.43% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,210** | **39.71%** | **217,439** | **30.43%** |
...
| 2 | `0x600ecb50` | `0x6013d4e4` | 330132 | 97789 | 1046 | 390 | 29.6% | `FUN_601054dc` (2546B @ `601054dc`) |
...
| Decompiled (in census) | 3,356 | 497,162 |
...
| **Understood in some way (union)** | **3,356 (60.3%)** | **497,162 (69.6%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,210 (39.7%), or **2,210 (39.7%) excluding BTA-identified** | 217,439 (30.4%), or **217,439 (30.4%) excluding BTA-identified** |
