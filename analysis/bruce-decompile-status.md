...
**Snapshot: 2026-08-18 (full regeneration, session 86 / Wave 56).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 86 (2634 decomp files, 2634 in-census). Decompiled in-census functions grew to **2634** (427,514 bytes, 59.77% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 2,634 | 47.56% | 427,514 | 59.77% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 2,634 | 47.56% | 427,514 | **59.77%** |
| **Totally unknown** (no attribution, no decompile) | 2,904 | 52.44% | 287,741 | **40.23%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 2,904 | 52.44% | 287,741 | 40.23% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **2,904** | **52.44%** | **287,741** | **40.23%** |
...
| 3† | `0x600df286` | `0x600ea868` | 46562 | 44824 | 331 | 80 | 96.3% | `FUN_600e398a` (6270B @ `600e398a`) |
...
| Decompiled (in census) | 2,634 | 427,514 |
...
| **Understood in some way (union)** | **2,634 (47.6%)** | **427,514 (59.8%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 2,904 (52.4%), or **2,904 (52.4%) excluding BTA-identified** | 287,741 (40.2%), or **287,741 (40.2%) excluding BTA-identified** |
