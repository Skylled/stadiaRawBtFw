...
**Snapshot: 2026-08-18 (full regeneration, session 69 / Wave 39).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 69 (2294 decomp files, 2294 in-census). Decompiled in-census functions grew to **2294** (407,592 bytes, 56.95% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 2,294 | 41.42% | 407,592 | 56.95% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 2,294 | 41.42% | 407,592 | **56.95%** |
| **Totally unknown** (no attribution, no decompile) | 3,245 | 58.58% | 308,139 | **43.05%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 3,245 | 58.58% | 308,139 | 43.05% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **3,245** | **58.58%** | **308,139** | **43.05%** |
...
| 6† | `0x600d8a12` | `0x600df24c` | 26682 | 24440 | 432 | 126 | 91.6% | `FUN_600dcf8c` (984B @ `600dcf8c`) |
...
| Decompiled (in census) | 2,294 | 407,592 |
...
| **Understood in some way (union)** | **2,294 (41.4%)** | **407,592 (56.9%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 3,245 (58.6%), or **3,245 (58.6%) excluding BTA-identified** | 308,139 (43.1%), or **308,139 (43.1%) excluding BTA-identified** |
