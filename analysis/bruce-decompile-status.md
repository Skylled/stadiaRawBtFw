...
**Snapshot: 2026-08-18 (full regeneration, session 68 / Wave 38).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 68 (2274 decomp files, 2274 in-census). Decompiled in-census functions grew to **2274** (406,354 bytes, 56.77% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 2,274 | 41.05% | 406,354 | 56.77% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 2,274 | 41.05% | 406,354 | **56.77%** |
| **Totally unknown** (no attribution, no decompile) | 3,265 | 58.95% | 309,377 | **43.23%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 3,265 | 58.95% | 309,377 | 43.23% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **3,265** | **58.95%** | **309,377** | **43.23%** |
...
| 6† | `0x600d8a12` | `0x600df24c` | 26682 | 24440 | 432 | 106 | 91.6% | `FUN_600dcf8c` (984B @ `600dcf8c`) |
...
| Decompiled (in census) | 2,274 | 406,354 |
...
| **Understood in some way (union)** | **2,274 (41.1%)** | **406,354 (56.8%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 3,265 (58.9%), or **3,265 (58.9%) excluding BTA-identified** | 309,377 (43.2%), or **309,377 (43.2%) excluding BTA-identified** |
