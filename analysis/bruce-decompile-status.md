...
**Snapshot: 2026-08-18 (full regeneration, session 66 / Wave 36).** This is a **full regeneration**, not a hand-patch — every table below comes from a fresh address-based join against `bruce_functions.csv`, `bruce_srcmap.csv`, and a directory listing of `analysis/decomp/` taken at the conclusion of session 66 (2232 decomp files, 2232 in-census). Decompiled in-census functions grew to **2232** (404,942 bytes, 56.58% of code), with **139 of 139** attributed source files fully decompiled.
...
| **Decompiled** (`analysis/decomp/*.c`, matched to census) | 2,232 | 40.30% | 404,942 | 56.58% |
| **Attributed ∪ Decompiled** (understood in *some* way) | 2,232 | 40.30% | 404,942 | **56.58%** |
| **Totally unknown** (no attribution, no decompile) | 3,307 | 59.70% | 310,789 | **43.42%** |
...
|---|---:|---:|---:|---:|
| Totally unknown (§1, includes BTA-identified-but-undecompiled) | 3,307 | 59.70% | 310,789 | 43.42% |
| — of which: BTA-identified, module known, just not decompiled | 0 | 0.00% | 0 | 0.00% |
| **— truly unidentified (no attribution, no decompile, no module ID)** | **3,307** | **59.70%** | **310,789** | **43.42%** |
...
| 6† | `0x600d8a12` | `0x600df24c` | 26682 | 24440 | 432 | 64 | 91.6% | `FUN_600dcf8c` (984B @ `600dcf8c`) |
...
| Decompiled (in census) | 2,232 | 404,942 |
...
| **Understood in some way (union)** | **2,232 (40.3%)** | **404,942 (56.6%)** |
| **Completely unknown — no attribution, no decompile, no module ID** | 3,307 (59.7%), or **3,307 (59.7%) excluding BTA-identified** | 310,789 (43.4%), or **310,789 (43.4%) excluding BTA-identified** |
